...
public abstract class AddressParametersHeader extends ParametersHeader implements  Parameters {
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.AddressParameters#getAddress()
     */
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.AddressParameters#setAddress(android.javax.sip.address.Address)
     */
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.AddressParameters#clone()
     */
    public Object clone() {
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.AddressParameters#equals(java.lang.Object)
     */
