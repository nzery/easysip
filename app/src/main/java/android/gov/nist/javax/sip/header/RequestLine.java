...
public class RequestLine extends SIPObject implements SipRequestLine {
    ...
    *
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.SipRequestLine#getUri()
     */
    ...
    */
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.SipRequestLine#getMethod()
     */
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.SipRequestLine#getSipVersion()
     */
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.SipRequestLine#setUri(android.gov.nist.javax.sip.address.GenericURI)
     */
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.SipRequestLine#setMethod(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.SipRequestLine#setSipVersion(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.SipRequestLine#getVersionMajor()
     */
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.SipRequestLine#getVersionMinor()
     */
