...
public final class StatusLine extends SIPObject implements SipStatusLine {
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.SipStatusLine#getSipVersion()
     */
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.SipStatusLine#getStatusCode()
     */
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.SipStatusLine#getReasonPhrase()
     */
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.SipStatusLine#setSipVersion(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.SipStatusLine#setStatusCode(int)
     */
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.SipStatusLine#setReasonPhrase(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.SipStatusLine#getVersionMajor()
     */
    ...
    /* (non-Javadoc)
     * @see android.gov.nist.javax.sip.header.SipStatusLine#getVersionMinor()
     */
