...
public class ContentImpl implements Content {
   ...
   * (non-Javadoc)
   * 
   * @see android.gov.nist.javax.sip.message.ContentExt#setContent(java.lang.String)
   */
   ...
   * (non-Javadoc)
   * 
   * @see android.gov.nist.javax.sip.message.ContentExt#getContentTypeHeader()
   */
   ...
   * (non-Javadoc)
   * 
   * @see android.gov.nist.javax.sip.message.Content#getContent()
   */
