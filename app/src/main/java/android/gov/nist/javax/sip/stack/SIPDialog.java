...
public class SIPDialog implements android.javax.sip.Dialog, DialogExt {
  ...
  private transient AckSendingStrategy ackSendingStrategy = new AckSendingStrategyImpl();
     ...
     * 
     * @see
     * android.javax.sip.Dialog#sendReliableProvisionalResponse(android.javax.sip.message.Response
     * )
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.gov.nist.javax.sip.DialogExt#setBackToBackUserAgent(boolean)
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.gov.nist.javax.sip.DialogExt#setReleaseReferences(boolean)
     */
