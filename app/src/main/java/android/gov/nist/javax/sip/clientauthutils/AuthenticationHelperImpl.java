...
public class AuthenticationHelperImpl implements AuthenticationHelper {
     ...
     * (non-Javadoc)
     *
     * @see android.gov.nist.javax.sip.clientauthutils.AuthenticationHelper#handleChallenge(android.javax.sip.message.Response,
     ...
     * (non-Javadoc)
     *
     * @see android.gov.nist.javax.sip.clientauthutils.AuthenticationHelper#attachAuthenticationHeaders(android.javax.sip.message.Request)
     */
     ...
     * (non-Javadoc)
     *
     * @see android.gov.nist.javax.sip.clientauthutils.AuthenticationHelper#removeCachedAuthenticationHeaders(java.lang.String)
     */
