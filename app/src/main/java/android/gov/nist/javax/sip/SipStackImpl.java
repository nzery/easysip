 ...
 * <ul>
 *
 * <li><b>android.gov.nist.javax.sip.TRACE_LEVEL = integer </b><br/>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.SERVER_LOG = fileName </b><br/>
 * <b> Use of this property is still supported but deprecated. Please use
 * android.gov.nist.javax.sip.STACK_LOGGER and android.gov.nist.javax.sip.SERVER_LOGGER for
 * integration with logging frameworks and for custom formatting of log records.
 ...
 *
 * <li><b>android.gov.nist.javax.sip.DEBUG_LOG = fileName </b> <b> Use of this property
 ...
 * </font></li>
 *
 * <li><b>android.gov.nist.javax.sip.LOG_MESSAGE_CONTENT = true|false </b><br/>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.LOG_STACK_TRACE_ON_MESSAGE_SEND = true|false </b><br/>
 * Set true if you want to to log a stack trace at INFO level for each message
 * send. This is really handy for debugging.</li>
 *
 * <li><b>android.gov.nist.javax.sip.STACK_LOGGER = full path name to the class
 * implementing android.gov.nist.core.StackLogger interface</b><br/>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.SERVER_LOGGER = full path name to the class
 * implementing android.gov.nist.core.ServerLogger interface</b><br/>
 * If this property is defined the sip stack will try to instantiate it through
 * a no arg constructor. This allows to use different logging implementations
 ...
 *
 * <li><b>android.gov.nist.javax.sip.AUTOMATIC_DIALOG_ERROR_HANDLING = [true|false] </b>
 * <br/>
 ...
 * </ul>
 *
 * <li><b>android.gov.nist.javax.sip.IS_BACK_TO_BACK_USER_AGENT = [true|false] </b> <br/>
 ...
 * <li><b>android.gov.nist.javax.sip.MAX_MESSAGE_SIZE = integer</b> <br/>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.DELIVER_TERMINATED_EVENT_FOR_NULL_DIALOG = [true|false] </b><br/>
 ...
 * </li>
 *
 * <li><b>android.gov.nist.javax.sip.CACHE_SERVER_CONNECTIONS = [true|false] </b> <br/>
 ...
 *
 *
 * <li><b>android.gov.nist.javax.sip.CACHE_CLIENT_CONNECTIONS = [true|false] </b> <br/>
 * Default value is true. Setting this to false makes the Stack close the server
 ...
 * performance.</li>
 *
 * <li><b>android.gov.nist.javax.sip.THREAD_POOL_SIZE = integer </b> <br/>
 ...
 * </ul>
 *
 * <li><b>android.gov.nist.javax.sip.REENTRANT_LISTENER = true|false </b> <br/>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.MAX_CONNECTIONS = integer </b> <br/>
 * Max number of simultaneous TCP connections handled by stack.</li>
 *
 * <li><b>android.gov.nist.javax.sip.MAX_SERVER_TRANSACTIONS = integer </b> <br/>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.MAX_CLIENT_TRANSACTIONS = integer </b> <br/>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.PASS_INVITE_NON_2XX_ACK_TO_LISTENER = true|false
 * </b> <br/>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.MAX_LISTENER_RESPONSE_TIME = Integer </b> <br/>
 ...
 * the listener.
 *
 * <li><b>android.gov.nist.javax.sip.MAX_TX_LIFETIME_INVITE = Integer </b> <br/>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.MAX_TX_LIFETIME_NON_INVITE = Integer </b> <br/>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.DELIVER_TERMINATED_EVENT_FOR_ACK = [true|false]</b>
 * <br/>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.READ_TIMEOUT = integer </b> <br/>
 ...
 * to be.</li>
 *
 * <li><b>android.gov.nist.javax.sip.CONNECTION_TIMEOUT = integer </b> <br/>
 ...
 *  *
 * <li><b>android.gov.nist.javax.sip.NETWORK_LAYER = classpath </b> <br/>
 ...
 * features).</li>
 *
 * <li><b>android.gov.nist.javax.sip.ADDRESS_RESOLVER = classpath </b><br/>
 ...
 * android.gov.nist.javax.sip.DefaultAddressResolver.</li>
 *
 * <li><b>android.gov.nist.javax.sip.AUTO_GENERATE_TIMESTAMP= [true| false] </b><br/>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.THREAD_AUDIT_INTERVAL_IN_MILLISECS = long </b> <br/>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.NIO_MAX_SOCKET_IDLE_TIME = long </b> <br/>
 ...
 * </li>
 *
 * <li><b>android.gov.nist.javax.sip.NIO_BLOCKING_MODE = String </b> <br/>
 ...
 * </li> *
 *
 * <li><b>android.gov.nist.javax.sip.stack.USE_DIRECT_BUFFERS = [true|false]</b> <br/>
 ...
 * </li>
 *
 * <li><b>android.gov.nist.javax.sip.COMPUTE_CONTENT_LENGTH_FROM_MESSAGE_BODY =
 * [true|false] </b> <br/>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.CANCEL_CLIENT_TRANSACTION_CHECKED = [true|false]
 * </b> <br/>
 ...
 *
 *
 * <li><b>android.gov.nist.javax.sip.RECEIVE_UDP_BUFFER_SIZE = int </b> <br/>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.SEND_UDP_BUFFER_SIZE = int </b> <br/>
 * Default is <it>8*1024</it>. This property control the size of the UDP buffer
 * used for SIP messages. Under load, if the buffer capacity is overflown the
 * messages are dropped causing retransmissions, further increasing the load and
 * causing even more retransmissions. Good values to this property for servers
 ...
 *
 * <li><b>android.gov.nist.javax.sip.CONGESTION_CONTROL_TIMEOUT = int </b> How
 ...
 * </li>
 *
 * <li><b>android.gov.nist.javax.sip.TCP_POST_PARSING_THREAD_POOL_SIZE = integer </b>
 ...
 * </li>
 *
 * <li><b>android.gov.nist.javax.sip.DELIVER_UNSOLICITED_NOTIFY = [true|false] </b> <br/>
 ...
 * dialog.</li>
 *
 * <li><b>android.gov.nist.javax.sip.REJECT_STRAY_RESPONSES = [true|false] </b> Default
 ...
 *
 * <li><b>android.gov.nist.javax.sip.MAX_FORK_TIME_SECONDS = integer </b> Maximum time for which the original
 ...
 *
 * <li><b>android.gov.nist.javax.sip.EARLY_DIALOG_TIMEOUT_SECONDS=integer </b> Maximum time for which a dialog
 * can remain in early state. This is defaulted to 3 minutes ( 180 seconds).
 * </li>
 *
 * <li><b>android.gov.nist.javax.sip.THREAD_PRIORITY=integer </b> Control the priority of the threads started by the stack.
 * </li>
 *
 * <li><b>android.gov.nist.javax.sip.MESSAGE_PARSER_FACTORY =  name of the class implementing android.gov.nist.javax.sip.parser.MessageParserFactory</b>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.MESSAGE_PROCESSOR_FACTORY =  name of the class implementing android.gov.nist.javax.sip.parser.MessageProcessorFactory</b>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.TIMER_CLASS_NAME =  name of the class implementing android.gov.nist.javax.sip.stack.timers.SipTimer</b> interface
 ...
 *
 * <li><b>android.gov.nist.javax.sip.DELIVER_RETRANSMITTED_ACK_TO_LISTENER=boolean</b> A testing property
 * that allows application to see the ACK for retransmitted 200 OK requests. <b>Note that this is for test
 * purposes only</b></li>
 *
 * <li><b>android.gov.nist.javax.sip.AGGRESSIVE_CLEANUP=boolean</b> <b>Deprecated - use RELEASE_REFERENCES_STRATEGY instead</b>
 ...
 *
 * <li><b>android.gov.nist.javax.sip.RELEASE_REFERENCES_STRATEGY=String</b>
 ...
 *
 *
 * <li><b>android.gov.nist.javax.sip.MIN_KEEPALIVE_TIME_SECONDS = integer</b> Minimum time between keep alive
 ...
 * </li>
 *
 * <li><b>android.gov.nist.javax.sip.DIALOG_TIMEOUT_FACTOR= integer</b> Default to 64. The number of ticks before a
 ...
 * </li>
 *
 * <li><b>android.gov.nist.javax.sip.SIP_MESSAGE_VALVE= String</b> Default to null. The class name collection of your custom valve components. The classes
 ...
 * </li>
 *
 * <li><b>android.gov.nist.javax.sip.SIP_EVENT_INTERCEPTOR</b> Default to null. The class name of your custom interceptor object.
 ...
 *  is <b>android.gov.nist.javax.sip.stack.CallAnalysisInterceptor</b>, which will periodically check for requests stuck in the
 ...
 *
 *  <li><b>android.gov.nist.javax.sip.TLS_CLIENT_PROTOCOLS = String </b>
 ...
 * </li>
 *
 *  <li><b>android.gov.nist.javax.sip.android.gov.nist.javax.sip.ENABLED_CIPHER_SUITES = String </b>
 ...
 *
 *
 * <li><b>android.gov.nist.javax.sip.TLS_SECURITY_POLICY = String </b> The fully qualified path
 * name of a TLS Security Policy implementation that is consulted for certificate verification
 * of outbund TLS connections.
 * </li>
 *
 * <li><b>android.gov.nist.javax.sip.TLS_CLIENT_AUTH_TYPE = String </b> Valid values are Default (backward compatible with previous versions)
 ...
 * </li>
 *
 *<li><b>android.gov.nist.javax.sip.RELIABLE_CONNECTION_KEEP_ALIVE_TIMEOUT</b> Value in seconds which is used as default keepalive timeout
 * (See also http://tools.ietf.org/html/rfc5626#section-4.4.1). Defaults to "infiinity" seconds (i.e. timeout event not delivered).</li>
 *
 * <li><b>android.gov.nist.javax.sip.SSL_HANDSHAKE_TIMEOUT</b> Value in seconds which is used as default timeout for performing the SSL Handshake
 * This prevents bad clients of connecting without sending any data to block the server</li>
 *
 * <li><b>android.gov.nist.javax.sip.SSL_RENEGOTIATION_ENABLED = [true|false]</b> Default value is <b>true</b>. Allow or disallow SSL renegotiation to resolve potential DoS problem -
...
public class SipStackImpl extends SIPTransactionStack implements
	...
	public SipStackImpl(Properties configurationProperties)
		...
		String connTimeout = configurationProperties
				.getProperty("android.gov.nist.javax.sip.CONNECTION_TIMEOUT");
		if (connTimeout != null) {
			try {
		...
		super.setPatchReceivedRport(Boolean.parseBoolean(configurationProperties.getProperty(
				"android.gov.nist.javax.sip.NEVER_ADD_RECEIVED_RPORT", "false")));
		...
		try {
			...
			logger
				.logError(
						"Bad configuration value for android.gov.nist.javax.sip.NIO_BLOCKING_MODE=" + nioMode, e);
		}
